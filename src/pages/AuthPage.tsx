...
//       if (/pending|قيد الانتظار|not approved|charity not found|not found|not active/i.test(msg)) {
...
//           setLocation(getRedirectByRole(res.user?.roleType || 'admin'));
//         } else {
//           onSwitch(); // ✅ بدل setMode — بيروح لصفحة اللوجين
//         }
//       }, 1500);
